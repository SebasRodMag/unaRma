...
| usados por la clase de validador. Algunas de estas reglas tienen versiones
| múltiples, como las reglas de tamaño. Siéntete libre de modificar cada uno
...
|---------------------------------------------------------------------------
|
| Las siguientes líneas de idioma se utilizan para cambiar nuestro marcador
| de posición de atributo por algo más amigable para el lector, como "Dirección
| de correo electrónico" en lugar de "email". Esto nos ayuda a hacer que
